...
import id.co.itasoft.tilaka.library.body.RegisterForReenrollData;
import id.co.itasoft.tilaka.library.response.ResponseRegisterForReenroll;
 ...
 * @author User
 */
public class TilakaRegisterForReenroll extends Element implements PluginWebSupport {

    public static String pluginName = "ISTW - DS - Tilaka Register For Reenroll";
        ...
        if (!workflowUserManager.isCurrentUserAnonymous()) {
            ...
            try (TilakaApiServices apiService = new TilakaApiServices(ConstData.tilaka_adapter_api_hostname_url)) {
                ...
                try {
                    ...
                    RegisterForReenrollData datatoSend = new RegisterForReenrollData();
                    ...
                    LogUtil.info(this.getClass().getName(), datatoSend.toString());

                    ResponseRegisterForReenroll objouput = apiService.RegisterForReenroll(datatoSend, ConstData.tilaka_channel_id, ConstData.tilaka_client_secret);
