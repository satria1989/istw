 ...
 * @author User
 */
public class TilakaRegisterForKycCheck extends Element implements PluginWebSupport {

    public static String pluginName = "ISTW - DS - Tilaka Register For KYC Check";
        ...
        if (!workflowUserManager.isCurrentUserAnonymous()) {
            ...
            try (TilakaApiServices apiService = new TilakaApiServices(ConstData.tilaka_adapter_api_hostname_url)) {
                ...
                try {
                    ...
                    ResponseRegisterForKycCheck objouput = apiService.RegisterForKycCheck(datatoSend, ConstData.tilaka_channel_id, ConstData.tilaka_client_secret);
