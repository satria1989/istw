 ...
 * @author User
 */
public class TilakaRegisterForReenrollWNA extends Element implements PluginWebSupport {

    public static String pluginName = "ISTW - DS - Tilaka Register For Reenroll WNA";
        ...
        if (!workflowUserManager.isCurrentUserAnonymous()) {
            ...
            try (TilakaApiServices apiService = new TilakaApiServices(ConstData.tilaka_adapter_api_hostname_url)) {
                ...
                try {
                    ...
                    ResponseRegisterForReenroll objouput = apiService.RegisterForReenrollWna(datatoSend, ConstData.tilaka_channel_id, ConstData.tilaka_client_secret);
