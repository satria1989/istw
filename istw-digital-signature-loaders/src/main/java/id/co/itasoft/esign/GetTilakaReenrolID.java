...
import id.co.itasoft.tilaka.library.response.ResponseGenerateUUIDReenrol;
 ...
 * @author User
 */
public class GetTilakaReenrolID extends Element implements PluginWebSupport {

    public static String pluginName = "ISTW - DS - Get Tilaka Reenroll ID";
        ...
        if (!workflowUserManager.isCurrentUserAnonymous()) {
            ...
            try (TilakaApiServices apiService = new TilakaApiServices(ConstData.tilaka_adapter_api_hostname_url)) {
                try {
                    ...
                    ResponseGenerateUUIDReenrol objouput = apiService.GenerateUUIDReenrol(user_identifier);
